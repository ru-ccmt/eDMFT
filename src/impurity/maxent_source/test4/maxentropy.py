...
def test6b(fin,fout,Norder=100,L=10,Nmax=150): #filename,Norder=100,L=10):
    ...
    Gx = PadeTest(om, Gm, x, gamma, Norder)
    savetxt(fout, vstack((x,real(Gx),imag(Gx))).transpose())
...
if __name__ == '__main__':
    ...
    test6b('Gf.out_T_0.005', 'Gr_T_0.005', 124, 20.)
    test6b('Gf.out_T_0.1875', 'Gr_T_0.1875', 54, 20.)
    test3('Gf.out_T_0.005', 'fermi', 0.005, 200, 20.)
